...
# Enable debug mode (shows interactive traceback in browser) :contentReference[oaicite:1]{index=1}
app = FastAPI(debug=True)

# Global exception handler to log and return full tracebacks 
...
# File validation (YouTube supports MP4, MOV, AVI, MKV, WebM, etc.) :contentReference[oaicite:2]{index=2}&#8203;:contentReference[oaicite:3]{index=3}
...
async def upload_video(
    ...
    return {"video_id": resp.get("id"), "message": "Upload complete!"}
